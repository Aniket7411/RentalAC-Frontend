  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className={`border-2 rounded-lg p-4 cursor-pointer transition-all ${selectedOption === 'full'
            ? 'border-primary-blue bg-blue-50'
            : 'border-gray-200 hover:border-primary-blue/50'
          }`}
      >
        <div className="flex items-start space-x-4">
          <div className={`flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center ${selectedOption === 'full' ? 'border-primary-blue bg-primary-blue' : 'border-gray-300'
            }`}>
            {selectedOption === 'full' && (
          ...
          <div className="flex-1">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="px-2 py-1 bg-green-100 text-green-800 text-xs font-semibold rounded">
                {instantPaymentDiscount}% OFF
              </span>
            </div>
            <p className="text-sm text-text-light mb-2">
              Pay the complete amount upfront and get a {instantPaymentDiscount}% discount
            </p>
      ...
      <motion.div
        ...
        className={`border-2 rounded-lg p-4 cursor-pointer transition-all ${selectedOption === 'advance'
            ? 'border-primary-blue bg-blue-50'
            : 'border-gray-200 hover:border-primary-blue/50'
          }`}
      >
        <div className="flex items-start space-x-4">
          <div className={`flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center ${selectedOption === 'advance' ? 'border-primary-blue bg-primary-blue' : 'border-gray-300'
            }`}>
