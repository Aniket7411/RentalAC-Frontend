...
const ServiceCard = ({ service, onAddClick, onView }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-2 group"
    >
      {/* Image on top */}
      <div
